...
[![Build](https://github.com/tmicheletto/setup/actions/workflows/ci.yml/badge.svg)](https://github.com/tmicheletto/setup/actions/workflows/ci.yml)
...
```
git clone https://github.com/tmicheletto/setup.git ~/code/setup
...
```
==> benchmarking login shell of user tmicheletto ...
creates_tty=0
has_compsys=1
