...
#PIP_REQUIRE_VIRTUALENV=false $pip install --force-reinstall --break-system-packages pip
...
PIP_REQUIRE_VIRTUALENV=false $pip install --force-reinstall --break-system-packages virtualenv
...
pyenv_install_brew_version 3.13
pyenv_install_brew_version 3.14
